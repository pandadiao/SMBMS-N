...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
			...
			<p><strong>证件照：</strong><span><img src="${pageContext.request.contextPath}${user.idPicPath}"/></span></p>
            <p><strong>图片：</strong><span><img src="${pageContext.request.contextPath}${user.workPicPath}"/></span></p>
			<div class="providerAddBtn">
            	<input type="button" id="back" name="back" value="返回" onclick="" >
            </div>
        </div>
    </div>
</section>
